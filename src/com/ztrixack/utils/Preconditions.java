...
public final class Preconditions {
    ...
    /**
     * Ensures that an reference passed as a parameter to the calling
     * method is not zero.
     *
     ...
     */
    public static int checkNotDivideByZero(int reference) {
    	if (reference == 0) {
     ...
     * @throws NullPointerException if {@code reference} is null
     */
    public static int checkNotZeroSize(int reference) {
        if (reference == 0) {
