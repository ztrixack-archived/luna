 ...
 * 
 * 
 * How to use: Boast.showText(CONTEXT, TEXT); Boast.showText(CONTEXT, ResID);
 * You can get context from activity (activity.getApplicationContext()) TEXT is
 * a string that you want to show in Toast notifications. ResID is a integer
 * type. You can show a text in resource id. You can replace default
 * notifications.
 * 
 * ** Recommenced ** You should be use runOnUiThread() for calling Boast
 * notifications. But 'this' must be current activity.
 * 
 * Example: this.runOnUiThread(new Runnable() {
 * 
 * @Override public void run() { Boast.showText(this.getApplicationContext(),
 *           "Hello!"); } });
 */
public class Boast {
	/**
	...
	public static void showText(final Activity activity, CharSequence text) {
		activity.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Boast.showText(activity.getApplicationContext(), "Hello!");
			}
		});
	}
